    ...
    <section class="projects-section bg-light" id="about">
        <div class="container">
            <div class="row align-items-center no-gutters mb-4 mb-lg-5">
                <div class="col-xl-4 col-lg-5"><img class="img-fluid mb-3 mb-lg-0" src="<?= base_url(); ?>/images/*.jpg" alt="" /></div>
                <div class="col-xl-8 col-lg-7">
                    <div class="featured-text text-center text-lg-left">
                        <h4>Biographie</h4>
                        <p class="text-black-50 mb-0">
                            Jeune <b>Infographiste 3D et Photographe / vidéaste</b><br />
                            <b>2 ans d’étude à *</b><br />
                        ...
                        <a href="<?= base_url(); ?>/uploads/*.pdf" class="cv">Mon CV</a>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center no-gutters mb-5 mb-lg-0">
                <div class="col-lg-6"><img class="img-fluid" src="<?= base_url(); ?>/images/*.jpg" alt="" /></div>
                <div class="col-lg-6">
