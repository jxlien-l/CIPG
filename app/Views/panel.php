...
<head>
  ...
  <link href="<?= base_url(); ?>/template-a/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
  <link href="<?= base_url(); ?>/template-a/css/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
  <div id="wrapper">
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url(); ?>/Panel/Contacts">
          <i class="far fa-address-book"></i>
          <span>Contacts</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url(); ?>/Panel/Galleries">
          <i class="fas fa-images"></i>
          <span>Galeries</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url(); ?>/Panel/Options">
          <i class="fas fa-wrench"></i>
          <span>Options</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url(); ?>/Panel/Profile">
          <i class="fas fa-user-circle"></i>
          <span>Profil</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url(); ?>/Panel/Video">
...
<script src="<?= base_url(); ?>/template-a/vendor/jquery/jquery.min.js"></script>
  ...
  <script src="<?= base_url(); ?>/template-a/vendor/chart.js/Chart.min.js"></script>
  <script src="<?= base_url(); ?>/template-a/js/demo/chart-area-demo.js"></script>
  <script src="<?= base_url(); ?>/template-a/js/demo/chart-pie-demo.js"></script>
</html>
